...
public class DBManager {
    ...
    private static final String DATABASE_URL = "jdbc:mysql://localhost/bhj20examproject?serverTimezone=UTC";
    ...
    public PreparedStatement prepareStatement(final String sql, int autoGeneratedKeys) throws SQLException {
        return openConnection().prepareStatement( sql, autoGeneratedKeys );
    }
